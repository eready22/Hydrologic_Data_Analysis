...
> aggregation: creating new data, adding data together?

> subsampling: take part of a sample

> interpolation: filling the gaps in a data
...
* **Linear**: straight line between known values
* **Spline**: curved quadratic line
seasonal: fill in June 6 air temp w/ average June 6 air temp
...
> The p-value for the overall seasonality test is too large to reject the null hypothesis, but Oct and Nov both have very low p-values and show a downward phosphorous trend.
