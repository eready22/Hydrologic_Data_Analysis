...
pH, turbidity, DO, heavy metals, nutrient levels, bacteria presence
## Session Set Up
...
> pH and specific conductance determine the suitability of habitat for life and how the stream interacts with the rest of its environment
...
> Huge differences in sampling, lots more sampling in Kanawha. In Kanawha, there's a period from 1963-1970 where they sampled frquently and the results were all over the place. Higher peaks of specific conductance in Kanawha.

Why might mining be causing the changes you see?

> Mining increased scrutiny of watershed and added minerals to the river.
...
> Remediation was successful at eliminating very acidic pH values and very high specific conductance values in the Kanawha River. It is strange that Twelvepole became more acidic.
...
> The Surface Mining regulations from 1977 had a significant difference on the water quality in the Kanawha River. This means that mining has an impact on water quality, and that the Surface Mining Act significantly changed the water quality measurements.
...
> Points is better because the measurements are dense, rather than spread out over time

EPA drinking water standards for Manganese are 0.05 *_mg/L_*. How does the Kanawha stack up?

> It is often higher than the EPA standard
